...
const ChatbotWidget: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 w-80 md:w-96 h-[500px] max-h-[70vh] bg-white rounded-lg shadow-xl flex flex-col z-50 animate-slide-in">
      <div className="flex items-center justify-between bg-primary text-white p-4 rounded-t-lg">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-xs opacity-80">Tire suas dúvidas aqui</p>
          </div>
        </div>
        <button
          onClick={closeChat}
      ...
      <div className="flex-1 overflow-y-auto p-4 bg-gray-50">
        ...
        {isLoading && (
          <div className="text-left mb-3">
            <div className="inline-block bg-white text-gray-800 rounded-lg rounded-tl-none px-4 py-2 shadow">
